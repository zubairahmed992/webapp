...
class MaskMarkerInspectController extends Controller {
    ...
    public function indexAction(){
        ...
        return $this->render('LoveThatFitSupportBundle:MaskMarkerInspect:index.html.twig', array(
    ...
    public function userAction(Request $request){
        ...
        $id = $decoded["id"];
        $mode = ($decoded["mode"] == "") ? null : $decoded["mode"];
        ...
        return $this->render('LoveThatFitSupportBundle:MaskMarkerInspect:_summary.html.twig', array(
                    'user' => $user,                    
                    'specs'=>$mm_specs,
    ...
    public function userJsonAction($id, $mode=null){
        $user = $this->get('user.helper.user')->find($id);
        $mm_specs=$this->getMaskedMarkerSpecs();
        $ub_specs=$user->getMeasurement()->getArray();
        $user_mm_comparison = $this->get('user.marker.helper')->getComparisionArraySupport($user);
