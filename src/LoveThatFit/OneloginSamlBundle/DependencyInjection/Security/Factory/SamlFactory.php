...
namespace LoveThatFit\OneloginSamlBundle\DependencyInjection\Security\Factory;
...
class SamlFactory extends AbstractFactory
{
    ...
    {
        return 'onelogin_saml.saml_listener';
    }
    ...
    protected function createAuthProvider(ContainerBuilder $container, $id, $config, $userProviderId)
    {
        ...
        $definition = $container->setDefinition($providerId, new DefinitionDecorator('onelogin_saml.saml_provider'))
        ...
        $factoryId = $config['token_factory'] ?: 'onelogin_saml.saml_token_factory';
    ...
    protected function createLogoutHandler($container, $id, $config)
    {
        if ($container->hasDefinition('security.logout_listener.'.$id)) {
            ...
            $samlListenerId = 'onelogin_saml.saml_logout';
            $container
