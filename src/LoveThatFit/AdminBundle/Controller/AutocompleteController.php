...
class AutocompleteController extends Controller {
    ...
    public function AutoCompleteUserIndexAction() {
	  return $this->render('LoveThatFitAdminBundle:AutoComplete:user_index.html.twig', array(
		'user' => '',
	  ));
    }
  ...
  public function AutoCompleteProductIndexAction() {
	return $this->render('LoveThatFitAdminBundle:AutoComplete:product_index.html.twig', array(
	  'produt' => '',
	));
  }
