...
class BannerTypes extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder->add('banner_type', 'choice', array(
            ...
            'choices'=> array('1'=>'Fullsize Banner','2'=>'Image with Title','3'=>'Text, Description with Price', 4 => "Shop the look", 5 => "Shop the look fitting room", 6 => "Product Detail"/*, 7 => "Category with specific filters"*/),
            'multiple' => false,
            'expanded' => false
        ));
