	...
	if($key){
	  ...
	  return array(
		...
		'belt' => $this->measurement?$this->measurement->getBelt():0,
                'top_placement' => $this->measurement?$this->measurement->getTopPlacement():0,
                'bottom_placement' => $this->measurement?$this->measurement->getBottomPlacement():0,
	  ...
	  return array(
		...
		$this->measurement?$this->measurement->getBelt():0,
                $this->measurement?$this->measurement->getTopPlacement():0,
                $this->measurement?$this->measurement->getBottomPlacement():0,
