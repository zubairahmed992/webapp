   ...
   public function getFeedBackListAction($product_item_id) {         
    ...
    private function get_pixel_variance($product){
        $product_pixel = array ('Arch Logo Zip Hoodie'  => 1,
                       ...
                       // 'Mens PJ Top' => -6,
                        'Mens Royal Robe' => -1,
                      'Chiliwear Sleeveless Polo White' => 1,
                      'Chiliwear Polo Navy' => 1,            
                      'Long Sleeve V Neck Tee' => 1,
                      'Venley Sleeveless Tee' => 2,
                      'Touch Cardigan Sweatshirt' => 1,
...
#-----------Added to closet method---------------------------------------------#
   ...
   #---------------------------User Manquine------------------------------------# 
    ...
    public function canvasAction() {
        ...
        return $this->render('LoveThatFitSiteBundle:InnerSite:index.html.twig', array('facebook'=>$fb_conf));        
    }
