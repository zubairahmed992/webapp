...
class UserOrderRepository extends EntityRepository
{
  ...
  public function findOneByUser($order_id,$user) {
	...
	public function findOrderListByUserID($user_id)
	{
		...
		o.shipping_phone, o.order_number, o.shipping_amount, o.discount_amount, o.total_amount,o.user_order_date, o.shipment_json')
		->from('LoveThatFitCartBundle:UserOrder', 'o')
	...
	public function findByOrderNo($order_number)
    {
        $query = $this->getEntityManager()->createQueryBuilder();
      	return $query->select('o.id, o.order_date, 
							...
							o.order_status, o.order_amount,
							o.transaction_status, o.transaction_id,
							o.payment_method, o.payment_json,
							o.billing_phone, o.shipping_phone,
							o.order_number, o.shipping_amount,
							o.discount_amount, o.total_amount,
							o.rate_json, o.user_order_date, 
							o.shipment_json, o.sales_tax,
							u.email, u.firstName, u.lastName,
							f.group_type, f.discount')
      	  	->from('LoveThatFitCartBundle:UserOrder', 'o')
      	  	->leftJoin("LoveThatFitUserBundle:User", "u", "WITH", "o.user = u.id")
      	  	->leftJoin("LoveThatFitAdminBundle:FNFGroup", "f", "WITH", "o.user_group = f.id")
