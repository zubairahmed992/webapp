...
class UserOrderDetailRepository extends EntityRepository
{
    public function findByOrderID($order_id)
    {
        ...
        return $query->select('ud.id as order_detail_id, ud.qty, ud.amount, ud.item_description, ud.sku, i.id as item_id, i.image, IDENTITY(i.product) as product_id, b.name as brand_name, p.name as product_name, p.control_number')
