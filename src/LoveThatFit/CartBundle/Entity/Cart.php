 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="LoveThatFit\CartBundle\Entity\CartRepository")
 */
class Cart
{

	/**
	 * @ORM\ManyToOne(targetEntity="LoveThatFit\AdminBundle\Entity\ProductItem", inversedBy="cart")
	 * @ORM\JoinColumn(name="product_item_id", referencedColumnName="id", onDelete="CASCADE")
	 */
	protected $product_item;

	/**
	 * @ORM\ManyToOne(targetEntity="LoveThatFit\UserBundle\Entity\User", inversedBy="cart")
